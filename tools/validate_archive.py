...
def validate_manifest_builder(errors: list[str]) -> None:
    ...
    try:
        ...
        if (
            ...
            and Path(root_check.stdout.strip()).resolve() == REPOSITORY_ROOT
        ):
            ...
            history_available = base_check.returncode == 0
    except OSError:
        pass
    if not history_available:
        print(
            "note: full Git history unavailable; skipped manifest provenance rebuild"
        )
        return

...
while i == "1":
    ...
    if con == 'y':
        ...
        print(nw2)
        nw2.write_touchstone(filename = f"{serial_num_1}",dir= 'C:\\Users\\RadioLab\\Desktop\\Enigma_Testing_2021\\Touchstone_Files')
       
        #plot a smith chart of s11
        nw2.plot_s_smith()
        plt.title(f"{serial_num_1} Smith Chart")
        plt.savefig(f"C:\\Users\\RadioLab\\Desktop\\Enigma_Testing_2021\\Smith_Charts\\{serial_num_1}.jpg")
        ...
        print(nw2)
        nw2.write_touchstone(filename = f"{serial_num_2}",dir= 'C:\\Users\\RadioLab\\Desktop\\Enigma_Testing_2021\\Touchstone_Files')
       
        #plot a smith chart of s11
        nw2.plot_s_smith()
        plt.title(f"{serial_num_2} Smith Chart")
        plt.savefig(f"C:\\Users\\RadioLab\\Desktop\\Enigma_Testing_2021\\Smith_Charts\\{serial_num_2}.jpg")
